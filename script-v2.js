...
// Datos de la malla: ramos con créditos y prerrequisitos
const malla = {
  "Primer Semestre": [
  ...
  // ... agrega los demás semestres de la misma forma
};
...
// Función para verificar prerrequisitos y actualizar desbloqueo
...
// Cargar estado guardado y actualizar desbloqueo inicial
cargarEstado();
actualizarDesbloqueo();
